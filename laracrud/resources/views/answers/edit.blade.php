    ...
    <div class="container">
        <form action="/answers/{{ $answer->id}}" method="post">
            ...
            <div class="form-group">
                <label for="formGroupExampleInput2">Edit Answer</label>
                <label for="formGroupExampleInput2">Isi</label>
                <input type="text" class="form-control @error ('isi') is-invalid @enderror" id="formGroupExampleInput2" placeholder="Isi" name="isi" value="{{ $answer->isi }}">
